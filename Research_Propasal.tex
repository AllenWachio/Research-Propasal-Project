...
\begin{document}
    ...
    animals are increasingly seen as threats rather than assets --- directly undermine
    conservation outcomes by reducing community support for protected areas and wildlife
    ...
    positionally accurate animal tracking---within 2--3\,m of industrial-grade GPS benchmarks---
    ...
    \cite{manoa2020}. Over the 2010--2018 period, wildlife threats to human life accounted for
    ...
    (estimated at 5,200--7,790\,km\textsuperscript{2} in the Amboseli landscape), and high
    ...
    complexity of HWC. India hosts an estimated 25,000--30,000 individuals across
    ...
    2014--2017 period due to missing documentation and insufficient funds, compounding
    ...
    hydrochloride (7--11\,mg depending on age and sex) facilitated by trained kumki elephants
    ...
    configurable recording intervals, achieving positional accuracy within 2--3\,m of an
    ...
    oxygenation within approximately 4.5--10\,minutes, compared to 23\,minutes for
    ...
    low cost, with demonstrated positional accuracy of 2--3\,m \cite{imamoglu2022} --- and is
    the conceptually novel contribution of the proposed research. Veterinary sedatives with
    well-characterised pharmacokinetic profiles (e.g., etorphine, medetomidine, or
    tiletamine-zolazepam combinations) would replace naloxone as the pharmacological
    ...
    A structured review of the literature across eight interrelated domains --- HWC scale and
    ...
    \begin{thebibliography}{99}
        ...
        \bibitem{muliya2026}
        S.~K. Muliya, V.~Kolipakam, R.~K. Pandey, S.~Sharma, K.~Pushkar,
        T.~C. Kuttappa, C.~C. Manjunath, U.~T. Bindhani, L.~Kawlni,
        V.~R. Tiwari, and Q.~Qureshi,
        ``Satellite-telemetry and mass communication based early warning system
        for human-elephant coexistence in Southern India's agroforestry landscapes,''
        \textit{Frontiers in Conservation Science}, vol.~6, p.~1640741, 2026.
        doi: 10.3389/fcosc.2025.1640741

        \bibitem{manoa2020}
        D.~O. Manoa, F.~Mwaura, T.~Thenya, and S.~Mukhovi,
        ``Comparative analysis of the typology, seasonality and economic cost of
        human-wildlife conflict in Kajiado and Laikipia Counties, Kenya,''
        \textit{East African Journal of Science, Technology and Innovation},
        vol.~1, no.~4, pp.~1--16, Sep. 2020.
        doi: 10.37425/eajsti.v1i4.188

        \bibitem{mbiki2025}
        S.~Mbiki,
        ``The elephant in the room: Examining the complex human-wildlife conflict in Kenya,''
        British Institute in Eastern Africa (BIEA), Feb. 2025. [Online].
        Available: \url{https://biea.ac.uk/the-elephant-in-the-room-examining-the-complex-human-wildlife-conflict-in-kenya/}

        \bibitem{basak2023}
        S.~M. Basak, E.~Rostovskaya, J.~Birks, and I.~A. Wierzbowska,
        ``Perceptions and attitudes to understand human-wildlife conflict in an urban
        landscape --- A systematic review,''
        \textit{Ecological Indicators}, vol.~151, p.~110319, 2023.
        doi: 10.1016/j.ecolind.2023.110319

        \bibitem{kenya2025}
        Republic of Kenya, Office of the President,
        ``Government steps up human-wildlife conflict response and compensation,''
        Official Website of the President of the Republic of Kenya, May 2025.
        [Online]. Available:
        \url{https://www.president.go.ke/government-steps-up-human-wildlife-conflict-response-and-compensation/}

        \bibitem{gilbert2026}
        S.~Gilbert,
        \textit{Virtual Fencing for Conservation: A Roadmap for Making Rangelands
            Work Better for Livestock and Wildlife}.
        Bozeman, MT: Property and Environment Research Center (PERC), 2026.
        [Online]. Available: \url{https://perc.org/VirtualRoadmap}

        \bibitem{imamoglu2022}
        A.~F. \.{I}mamo\u{g}lu and \.{I}.~Ta\c{s},
        ``Preliminary application of a low-cost smart collar developed for wild animal tracking,''
        \textit{European Journal of Forest Engineering}, vol.~8, no.~1, pp.~35--39, 2022.
        doi: 10.33904/ejfe.1131931

        \bibitem{gutierrez2014}
        J.~C. Guti\'errez-Hern\'andez, S.~Caffey, W.~Abdallah, P.~Calvillo,
        R.~Gonz\'alez, J.~Shih, J.~Brennan, J.~Zimmerman,
        J.~C. Mart\'inez-Camarillo, A.~R. Rodriguez, R.~Varma, A.~Santos,
        G.~S\'anchez, and M.~Humayun,
        ``One-year feasibility study of Replenish MicroPump for intravitreal drug
        delivery: A pilot study,''
        \textit{Translational Vision Science and Technology}, vol.~3, no.~3,
        Art. no.~8, 2014.
        doi: 10.1167/tvst.3.3.8

        \bibitem{iacovacci2021}
        V.~Iacovacci, I.~Tamadon, E.~F. Kauffmann, S.~Pane, V.~Simoni,
        L.~Marziale, M.~Aragona, L.~Cobuccio, M.~Chiarugi, P.~Dario,
        S.~Del Prato, L.~Ricotti, F.~Vistoli, and A.~Menciassi,
        ``A fully implantable device for intraperitoneal drug delivery refilled
        by ingestible capsules,''
        \textit{Science Robotics}, vol.~6, no.~57, p.~eabh3328, 2021.
        doi: 10.1126/scirobotics.abh3328

        \bibitem{ciatti2024}
        J.~L. Ciatti, A.~V\'azquez-Guardado, V.~E. Brings, J.~Park,
        B.~Ruyle, R.~A. Ober, A.~J. McLuckie, M.~R. Talcott, E.~A. Carter,
        A.~R. Burrell, R.~A. Sponenburg, J.~Trueb, P.~Gupta, J.~Kim,
        R.~Avila, M.~Seong, R.~A. Slivicki, M.~A. Kaplan,
        B.~Villalpando-Hernandez, N.~Massaly, M.~C. Montana, M.~Pet,
        Y.~Huang, J.~A. Mor\'on, R.~W. Gereau IV, and J.~A. Rogers,
        ``An autonomous implantable device for the prevention of death from
        opioid overdose,''
        \textit{Science Advances}, vol.~10, p.~eadr3567, 2024.
        doi: 10.1126/sciadv.adr3567

        \bibitem{abhinav2025}
        V.~Abhinav, P.~Basu, S.~S. Verma, J.~Verma, A.~Das, S.~Kumari,
        P.~R. Yadav, and V.~Kumar,
        ``Advancements in wearable and implantable BioMEMS devices: Transforming
        healthcare through technology,''
        \textit{Micromachines}, vol.~16, no.~5, p.~522, 2025.
